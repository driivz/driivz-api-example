...
class DriivzClusterRenderer<T : ClusterItem>(
    private val context: Context,
    private val scope: CoroutineScope,
    map: GoogleMap,
    clusterManager: ClusterManager<T>,
    val shouldRenderAsCluster: Boolean,
    @SuppressLint("RestrictedApi") private val viewRendererState: State<ComposeUiViewRenderer>,
